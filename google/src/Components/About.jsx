                                ...
                                <div className="col-lg-4">
                                    <div className="card mb-4">
                                        <div className="card-body text-center">
                                            <img
                                                src={UserDetails.user?.picture.url ? UserDetails.user?.picture.url : "https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp"}
                                                alt="avatar"
                                    ...
                                    <div className="card mb-4">
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-sm-9">
                                                    <p className="text-muted mb-0">{UserDetails.user?.emailAddress }</p>
                                                </div>
                                            </div>
                                            <hr />
                                            <div className="row">
